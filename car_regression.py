...
#===============================================================================
file_path_train = "/projectnb/msspbc/jordanstout/home/car_regression_kaggle_autogen/train_car.csv"
file_path_test = "/projectnb/msspbc/jordanstout/home/car_regression_kaggle_autogen/test_car.csv" 
file_path_subex = "/projectnb/msspbc/jordanstout/home/car_regression_kaggle_autogen/sample_submission.csv"

custom_prefix = "AIs_folder"
custom_dir = "/projectnb/msspbc/jordanstout/home/car_regression_kaggle_autogen"
temp_dir=tempfile.mkdtemp(prefix=custom_prefix, dir=custom_dir)
print(f"Temporary Directory Path: {temp_dir}")
try:
    file_name = os.path.basename(file_path_train)
    temp_file_path = os.path.join(temp_dir, file_name)
    shutil.copy(file_path_train, temp_file_path)

    file_name_2 = os.path.basename(file_path_test)
    temp_file_path_2 = os.path.join(temp_dir, file_name_2)
    shutil.copy(file_path_test, temp_file_path_2)
